...
def main():
    det_result_path = Path(
        "/mlcv/WorkingSpace/VAIPE/PillImageRec/haov/yolor/private_test_18e.csv")
    img_dir = Path("/mlcv/Databases/VAIPE/RELEASE_private_test/pill/image")
    save_dir = Path("../cropped_pill")
