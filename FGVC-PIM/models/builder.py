...
def build_swintransformerv2(pretrained: bool = False,
                          num_selects: Union[dict, None] = None, 
                          img_size: int = 384,
                          use_fpn: bool = True,
                          fpn_size: int = 512,
    ...
    backbone = timm.create_model('swinv2_large_window12to24_192to384_22kft1k', pretrained=pretrained)
...
MODEL_GETTER = {
    ...
    "swin-t-v2":build_swintransformerv2
}
